...
const HeroSection = ({ title, imageUrl }) => {
  return (
    <main className="bg-gradient-to-r from-[#f2d3f7] to-[#1eb6d9] h-[80vh] ">
      <div className="flex flex-col md:flex-row items-center w-[80%] mx-auto  gap-8 ">
        <div className="md:w-[50%] w-full p">
